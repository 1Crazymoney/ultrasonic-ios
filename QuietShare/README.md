iOS native app(in ObjectiveC) for transfering data over sound  using quite framework. Tested with iPHoneXR , able to send/receive between android and iOS devices.
